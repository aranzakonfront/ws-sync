...
def get_sc_batch_por_programa(pares_estudiante_programa: list[tuple[str, str]]) -> dict[tuple[str, str], str]:
    """
...
def get_sc_batch_sin_programa(ids_estudiante: list[str]) -> dict[str, str]:
    """
